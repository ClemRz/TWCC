...
var getExtraKeys = function (standardObj, testObj) {
    var stdKeys = _.keys(standardObj);
    var testKeys = _.keys(testObj);
    return _.difference(testKeys, stdKeys);
};
...
Arg.prototype.validate = function () {
    ...
    var errorMsg = '';
    if (_.isFunction(this.validationFn)) {
...
Arg.prototype.getFlag = function () {
    ...
    if (_.isFunction(this.customFlagFn)) {
        ...
        if (this.value || this.value === 0) {
            if (this.flag) {
                ...
                return '--' + _.string.dasherize(this.option);
            } else {
                return this.option;
            }
        }
...
Arg.prototype.getValue = function () {
    ...
    if (_.isFunction(this.customValueFn)) {
