...
Author:       Mike Adair madairATdmsolutions.ca
              ...
              Clement Ronzon clem.rz@gmail.com
License:      LGPL as per: http://www.gnu.org/copyleft/lesser.html
...
Proj4js = {
    ...
    */
    transform: function(source, dest, point) {
        ...
        if (!source.isConnector && !dest.isConnector) point = this.datum_transform( source.datum, dest.datum, point );
 ...
 *
     ...
     */
    scriptName: "proj4js-combined.CRO.1.0.3.js",
    ...
    loadScript: function(url, onload, onfail, loadCheck) {
      ...
      var script, head;
			script = $('<script></script>', {src:url, id:url, type:'text/javascript', defer:false})[0];
    ...
    checkReadyState: function() {
			var loadCheck;
      if ($(this).prop('readyState') == 'loaded') {
        if (!this.loadCheck()) {
