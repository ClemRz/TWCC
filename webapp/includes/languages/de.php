...
define('LOOKING_FOR_TRANSLATOR', 'Wir suchen nach jemandem, um Arabisch zu übersetzen TWCC suchen! <br> Wenn Sie interessiert sind, <a href="#" title="contact" class="contact">kontaktieren Sie uns bitte</a>.');
?>
