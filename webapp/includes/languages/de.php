...
<li class="wip">Entwurf einer Schnittstelle für mobile Geräte, Smartphones und Tablets.</li>
<li class="done">Entwurf einer REST API für mobile Geräte, Smartphones und Tablets.</li>
<li class="done">Mieten von einem neuen Server, um einen besseren und schnelleren Service zu bieten.</li>
</ul>');
...
define('PLEASE_DISABLE_YOUR_ADBLOCK', 'bitte deaktiviere deinen AdBlock');
...
define('ABOUT_CONTENT', '<h2>Was ist TWCC?</h2>
					<p>TWCC, "The World Coordinate Converter", ist ein '.sprintf(GIT_COMMITS_LINK, '<img src="'.DIR_WS_IMAGES.'opensource_32.png" alt="" width="32" height="32"><i>Open Source</i>').' Werkzeug zum Konvertieren von Koordinaten im Bezug auf
					...
					Entwicklung wurde für <a href="https://www.grottocenter.org/" target="_blank">GrottoCenter.org</a> durchgeführt.</p>
					<p>Besonderer Dank gilt: Roland Aigner, Alessandro Avaro, Leszek Pawlowicz, Lê Viết Thanh, Ahmed Qatar.</p>
...
define('WE_USE_COOKIES', 'Diese Website verwendet Cookies');
define('WE_USE_COOKIES_DESCRIPTION', 'Diese Website verwendet Cookies, um Benutzerfreundlichkeit zu verbessern. Durch die Nutzung unserer Website erklären Sie, dass alle Cookies in Übereinstimmung mit unseren Richtlinien zu Cookies zustimmen.');
define('READ_MORE', 'Lies mehr');

define('LOOKING_FOR_TRANSLATOR', 'Wir brauchen Ihre Hilfe, um TWCC in den folgenden Sprachen übersetzen:
<ul><li><img src="'.DIR_WS_IMAGES.'flags/PH.png" alt=""> Filipino</li></ul>
Wenn Sie interessiert sind, <a href="#" title="contact" class="contact">kontaktieren Sie uns bitte</a>.');
?>
