...
define('GOOGLE_PLUS_LOCALE', 'en_US');
...
define('SUPPORT_TEXT','We removed ads because we believe in providing quality tools. We count on your support to finance the infrastructure costs and keep TWCC free for everyone.');
define('HOW_WE_PLAN','How we plan to use funds:<br><ul>
<li>Cover recurring infrastructure costs (servers, domain, hosting).</li>
<li class="wip">Design of an interface for mobile devices, smartphones and tablets.
<br>Feel free to send us your feedback on the <a href="/m/en">beta version</a>!</li>
...
define('PLEASE_DISABLE_YOUR_ADBLOCK', 'please disable your AdBlock');
...
define('ABOUT_CONTENT', '<h2>What is TWCC?</h2>
					...
					<p>Special thanks to: Roland Aigner, Alessandro Avaro, Leszek Pawlowicz, Lê Viết Thanh, Ahmed Qatar.</p>
...
define('WE_USE_COOKIES', 'This website uses cookies');
define('WE_USE_COOKIES_DESCRIPTION', 'This website uses cookies to improve user experience. By using our website you consent to all cookies in accordance with our Cookie Policy.');
