...
define('SUPPORT_TEXT','لقد أزلنا الإعلانات لأننا نؤمن بتقديم أدوات عالية الجودة. نعتمد على دعمكم لتمويل تكاليف البنية التحتية والحفاظ على TWCC مجانياً للجميع.');
define('HOW_WE_PLAN','كيف نخطط الاستخدام التمويل:<br><ul>
<li>تغطية تكاليف البنية التحتية المتكررة (الخوادم، النطاق، الاستضافة).</li>
