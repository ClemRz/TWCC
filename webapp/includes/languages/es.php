...
define('MAPS', 'Mapas:');
define('GO', 'Busca!');
define('SEARCH_BY_ADDRESS', 'Buscar...');
...
define('SUPPORT_TEXT','Hemos eliminado los anuncios porque creemos en herramientas de calidad. Contamos con su apoyo para financiar los costos de infraestructura y mantener TWCC gratuito para todos.');
define('HOW_WE_PLAN','Cómo se planea utilizar los fondos:<br><ul>
<li>Cubrir los costos recurrentes de infraestructura (servidores, dominio, alojamiento).</li>
<li class="wip">Diseño de una interfaz para dispositivos móviles, teléfonos inteligentes y tabletas.
<br>No dudes en mandarnos tus comentarios acerca de la <a href="/m/es">version beta</a>!</li>
<li class="done">Diseño de una API REST para dispositivos móviles, teléfonos inteligentes y tabletas.</li>
<li class="done">Alquilar un nuevo servidor con el fin de prestar un servicio mejor y más rápido.</li>
</ul>');
...
define('PLEASE_DISABLE_YOUR_ADBLOCK', 'por favor deshabilite su AdBlock');
...
define('ABOUT_CONTENT', '<h2>¿Qué es TWCC?</h2>
					...
					<p>Un agradecimiento especial a: Roland Aigner, Alessandro Avaro, Leszek Pawlowicz, Lê Viết Thanh, Ahmed Qatar.</p>
...
define('COPY_TO_CLIPBOARD', 'Copiar al portapapeles');
...
define('WE_USE_COOKIES', 'Este sitio usa cookies');
define('WE_USE_COOKIES_DESCRIPTION', 'Este sitio usa cookies para ofrecerle una mejor experiencia. Usando nuestro sitio web usted acepta todas las cookies de acuerdo con nuestra Política de Cookies.');
define('READ_MORE', 'Leer más');

define('LOOKING_FOR_TRANSLATOR', 'Necesitamos su ayuda para traducir TWCC en los siguientes idiomas:
<ul><li><img src="'.DIR_WS_IMAGES.'flags/PH.png" alt=""> Filipino</li></ul>
Si usted está interesado, por favor <a href="#" title="contact" class="contact">póngase en contacto</a> con nosotros.');

define('REDIRECT_TO_MOBILE_VERSION', 'Existe una nueva version para dispositivos moviles (beta)! Click OK para continuar.');
?>
