 ...
 */
    ...
    class Config
    {
        ...
        private $productionServers = array('/^twcc\.free\.fr$/');
        private $stagingServers    = array();
        private $localServers      = array('/^127.0.0.1$/');
        ...
        private function production()
        {
            ...
            $this->dbName          = 'twcc';
            $this->dbReadUsername  = 'twcc';
            $this->dbWriteUsername = 'twcc';
            $this->dbReadPassword  = 'laUFW48g';
            $this->dbWritePassword = 'laUFW48g';
            $this->dbOnError       = '';
