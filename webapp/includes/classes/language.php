  ...
  class language {
    ...
    function language($lng = '') {
      $this->languages = array('ar' => 'ar([-_][[:alpha:]]{2})?|arabic',
			...
			$this->catalog_languages['fr'] = array('id' => 1,
																						 'name' => 'Français',
																						 'image' => 'images/fr.png',
																						 'iso' => 'fr');
			$this->catalog_languages['en'] = array('id' => 2,
																						 'name' => 'English',
																						 'image' => 'images/en.png',
																						 'iso' => 'en');
			$this->catalog_languages['es'] = array('id' => 3,
																						 'name' => 'Español',
																						 'image' => 'images/es.png',
																						 'iso' => 'es');
			$this->catalog_languages['vi'] = array('id' => 4,
																						 'name' => 'Việt',
																						 'image' => 'images/vi.png',
																						 'iso' => 'vi');
			$this->catalog_languages['de'] = array('id' => 5,
																						 'name' => 'Deutsch',
																						 'image' => 'images/de.png',
																						 'iso' => 'de');
			$this->catalog_languages['it'] = array('id' => 6,
																						 'name' => 'Italiano',
																						 'image' => 'images/it.png',
																						 'iso' => 'it');
