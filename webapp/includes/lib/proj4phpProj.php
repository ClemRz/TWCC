...
class Proj4phpProj {
     ...
     *    your application.
     *
     *    Modified by CRO 2011-11-20
     *      connect to database to get the definition
     */
    public function loadProjDefinition() {
        ...
        $CRS_code = ($this->srsAuth != "" ? strtoupper($this->srsAuth) . ':' : "") . $this->srsProjNumber;
        try {
            //Proj4php::loadScript( $filename );
            require_once(substr(realpath(__FILE__), 0, -20) . 'application_top.php');
            Proj4php::$defs[$CRS_code] = getPhpDef($CRS_code); // in functions/general.php
