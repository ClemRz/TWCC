<?PHP
    class Auth
    {
        const SALT = 'jaime lidee quapres la mort ca ne sera jamais pire quavant la naissance';
        ...
        public $user;
        public $expiryDate;
        public $loginUrl = 'login.php'; // Where to direct users to login // CRO 2013-02-12 removed '/'
        ...
        public function logout()
        {
            $this->loggedIn = false;
            $this->clearCookies();
            redirect(WEB_ROOT); //$this->sendToLoginPage(); //CRO 2013-02-12
        }
